    ...
    render() {
        return (
            <div className="specificQuestions row container section scrollspy" id="specificQuestions">
                <div className="specificQuestions__firstCol col s12">
                
                    <div className="specificQuestions row">
                        ...
                        <div className="specificQuestions__bladderGait row">
                            <div className="specificQuestions__bladderGait__bladder valign-wrapper col s12 m12 l6">
                                <h2>Bladder</h2>
                                <Input name="bladder" type="radio" value="normal" label="normal" />
                                <Input name="bladder" type="radio" value="abnormal" label="abnormal" />
                            </div>
                            <div className="specificQuestions__bladderGait__gait valign-wrapper col s12 m12 l6">
                                <h2>Gait</h2>
